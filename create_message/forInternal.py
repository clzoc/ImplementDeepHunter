    ...
    for batch_idx in range(batch_blocks):
        ...
        for i in range(6):
            ...
            for m in range(forCount.shape[0]):
                ...
                globalCoverageInformation[layer_index][batch_idx] = sat / (10 * forCount.shape[1])

            satwhole += runwhole(forCount, forCount.shape[0], forCount.shape[1])
            totalwhole += forCount.shape[0] * forCount.shape[1] * 10
...
np.save(
    "../message_to_frontend/internal/allCoverageInformation.npy",
